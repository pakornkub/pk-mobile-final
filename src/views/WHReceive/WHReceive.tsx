...
const WHReceive: React.FC = () => {
  ...
  const validateErrors = () => {
    ...
    if (!itemData.data.data.Location_ID || parseInt(itemData.data.data.Location_ID) !== 2) {
    ...
    if (!itemData.data.data.ItemStatus_ID || parseInt(itemData.data.data.ItemStatus_ID) !== 4) {
