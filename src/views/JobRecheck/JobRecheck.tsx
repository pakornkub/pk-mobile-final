          ...
          <Box flex={1}>
            ...
            <VStack space={5} p={5}>
                    ...
                    {bomData?.data?.data?.map((value: any, key: number) => {
                      return (
                        <DataTable.Row key={key}>
                          ...
                          <DataTable.Cell style={styles.table_title_54}>{value.FG}</DataTable.Cell>
              ...
              <HStack alignItems={'center'} justifyContent={'space-between'}>
                <FormControl w="50%" isRequired isInvalid={'QR_NO_BOX' in errors} isDisabled={disabledBox} pointerEvents={disabledBox ? 'none' : 'auto'}>
                  <Input
                    h={50}
                    size={20}
                    ref={refInputBox}
